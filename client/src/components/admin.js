...
class Admin extends React.Component {
    ...
    registerLand = async () => {
        await this.props.createProp(this.state.surveynumber, this.state.address.toLowerCase(), this.state.marketvalue, this.state.type, this.props.userinfo.citytown, this.props.userinfo.kebele, this.props.userinfo.state)
            ...
            <div className="superadmin admin">
                ...
                <div className="adminpanel">
                    ...
                    <div className="adminslist">
                        <p className="superadmintitle">Recently Registered Lands</p>
