...
class User extends React.Component {
    ...
    update = () => {
        axios.post('http://localhost:5000/api/user/update/' + this.props.address, { name: this.state.name, phone: this.state.phone, email: this.state.email, Id: this.state.Id })
            .then(res => {
        ...
        return (
            <div className="superadmin user">
                <div className="wrapper">
                    ...
                    <input className="app-input" type="text" name="Id" placeholder="ID No" value={this.state.Id} onChange={this.handleInput} />
                ...
                <div className="userwrap">
                    <div className="wrappersmall justifystart regprop">
                        ...
                        {this.state.propertiesList.map((info, index) => (
                            <div className="adminel" key={"adminelem-" + index}>
                                ...
                                <div className="adTown"><strong>City:</strong> {info.state}</div>
                    ...
                    {!this.state.search && <div className="wrappersmall justifystart">
                        ...
                        {this.state.searchres && <div className="adminel">
                            ...
                            <div className="adTown"><strong>Region:</strong> {this.state.searchres.state}</div>
                            <div className="adTown"><strong>Woreda:</strong> {this.state.searchres.citytown}</div>

                            <div className="adTown"><strong>Kebele:</strong> {this.state.searchres.kebele}</div>
